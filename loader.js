...
conn.query('CREATE TABLE messageThreads (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, buyer TEXT,buyer_nickname TEXT,seller_nickname TEXT , seller TEXT, post_id INTEGER, time INTEGER, seen INTEGER, last_poster TEXT)');


conn.query('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT,email TEXT,password TEXT,name TEXT)');
conn.query('CREATE TABLE temp (email TEXT, password TEXT, name TEXT, code TEXT)');